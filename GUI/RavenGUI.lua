...
Blatant = lib:CreateWindow("blatant",UDim2.new(0.23, 0, 0.1, 0),"")
Render = lib:CreateWindow("render",UDim2.new(0.62, 0, 0.1, 0),"")
Utility = lib:CreateWindow("utility",UDim2.new(0.82, 0, 0.1, 0),"")
Client = lib:CreateWindow("client",UDim2.new(0.435, 0, 0.4, 0),"")
Legit = lib:CreateWindow("legit",UDim2.new(0.82, 0, 0.8, 0),"")
